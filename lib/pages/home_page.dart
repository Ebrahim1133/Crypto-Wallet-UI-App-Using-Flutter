...
import 'package:cryptowallet/data/json.dart';
import 'package:cryptowallet/theme/colors.dart';
import 'package:cryptowallet/widgets/av_person.dart';

import 'package:cryptowallet/widgets/balance_card.dart';
import 'package:cryptowallet/widgets/card_slider.dart';
import 'package:cryptowallet/widgets/coin_card.dart';
import 'package:cryptowallet/widgets/coin_item.dart';
                      ...
                      Expanded(child: 
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3,),
                            Text("Ebrahim", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18,)),
                          ],
                        )
                      ),
                      AvatarImage("assets/images/you.jpg",
                        isSVG: false,
                        width: 35, height: 35, 
                        radius: 10,
                      )
